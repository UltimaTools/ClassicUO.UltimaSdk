    ...
    public sealed class AnimationEdit
    {
        ...
        public static void ExportToVD(int fileType, int body, string file, int animType, int[] actionsToInclude)
        {
            ...
            using (var bin = new BinaryWriter(fs))
            {
                ...
                HashSet<int> includeSet = null;
                if (actionsToInclude != null && actionsToInclude.Length > 0)
                    includeSet = new HashSet<int>(actionsToInclude);
        ...
        private static AnimIdx[] GetCache(int fileType)
        {
            switch (fileType)
            {
                case 1: return _animCache;
                case 2: return _animCache2;
                case 3: return _animCache3;
                case 4: return _animCache4;
                case 5: return _animCache5;
                default: return _animCache;
            }
        }
        ...
        public static void Save(int fileType, string path)
        {
            ...
            string idx = System.IO.Path.Combine(path, filename + ".idx");
            string mul = System.IO.Path.Combine(path, filename + ".mul");
