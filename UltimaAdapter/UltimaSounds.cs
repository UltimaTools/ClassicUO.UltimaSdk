...
namespace Ultima
{
    ...
    public static class Sounds
    {
        ...
        {
            string idx = System.IO.Path.Combine(path, "soundidx.mul");
            string mul = System.IO.Path.Combine(path, "sound.mul");
            ...
            using (var binmul = new BinaryWriter(fsmul))
            {
                for (int i = 0; i < _cache.Length; ++i)
                {
                    ...
                    else
                    {
                        ...
                        if (sound.Name != null)
                        {
                            ...
                            if (bb.Length > 32) Array.Resize(ref bb, 32);
                            bb.CopyTo(b, 0);
                        }
                ...
                try { fsidx.Flush(); fsmul.Flush(); fsidx.Close(); fsmul.Close(); } catch { }
            }
        }
